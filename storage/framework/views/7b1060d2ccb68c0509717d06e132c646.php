                ...
                <?php $__currentLoopData = $qualityStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="flex items-center gap-4 sm:gap-5">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="mt-1 max-w-md text-sm font-medium leading-5 text-[#4b5563] xl:text-base xl:leading-6">
...
<?php /**PATH D:\laragon\www\FUTABUS\packages\FuteBus\Core\src\Providers/../resources/views/partials/home/service-quality.blade.php ENDPATH**/ ?>