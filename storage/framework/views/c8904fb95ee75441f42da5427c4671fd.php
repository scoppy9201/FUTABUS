                                ...
                                <div class="flex min-h-21.25 items-center justify-between gap-4 px-4 py-3 transition-colors hover:bg-[#fff9f6]">
                                    <div class="min-w-0">
                                        ...
                                        <?php if($route->distance_km || $duration): ?>
                                            <p class="mt-1 text-sm font-medium leading-5 text-[#4b5563]">
...
<?php /**PATH D:\laragon\www\FUTABUS\packages\FuteBus\Core\src\Providers/../resources/views/partials/home/popular-routes.blade.php ENDPATH**/ ?>