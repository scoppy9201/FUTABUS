<section class="bg-[#fff7f3] py-12 sm:py-14">
    <div class="mx-auto w-full max-w-[1128px] px-4 sm:px-6 lg:px-0">
        ...
        @else
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                @foreach($popularRoutes as $group)
                    ...
                    <article class="overflow-hidden rounded-[12px] border border-gray-200 bg-white shadow-[0_3px_8px_rgba(0,0,0,.22)]">
                        <div class="relative h-[140px] overflow-hidden bg-gray-200">
                            <img
                                src="{{ asset($cityImage) }}"
                                alt="{{ $group['city'] }}"
                        ...
                        <div class="divide-y divide-[#e5e7eb]">
                            @foreach($group['routes']->take(3) as $route)
                                ...
                                <div class="flex min-h-[85px] items-center justify-between gap-4 px-4 py-3 transition-colors hover:bg-[#fff9f6]">
                                    <div class="min-w-0">
